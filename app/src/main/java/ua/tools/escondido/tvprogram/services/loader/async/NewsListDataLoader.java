...
public class NewsListDataLoader extends AsyncTask<Void, Void, List<News>> {

    private AsyncTaskCallback<List<News>> callback;
    private ProgressDialog progressDialog;
    private Context context;

    public NewsListDataLoader(Context context, AsyncTaskCallback<List<News>> callback) {
