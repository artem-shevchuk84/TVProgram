...
public enum Channels {
    ...
    FIVE_KANAL(HTTPS_BASE_PATH + "/channels/5kanal/", GET,ENCODING_1251,START_METRIC, "<noindex>", "r1L1J7E4oog"),
    ...
    ESPRESSO(HTTPS_BASE_PATH + "/channels/espresso_tv/", GET,ENCODING_1251,START_METRIC, "<noindex>", "N9_D6vKPUnM"),
